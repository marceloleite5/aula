	...
	<div class="d-flex justify-content-center h-100">
		...
		<div class="card">
			...
			<div class="card-header">
				<h3 class="text-center">Entre em contato conosco e dê sua opinião!</h3>
			...
			<div class="card-body">
                <form action="" method="post">
					...
					<div class="input-group form-group">
						...
						<input type="nome" name="nome" class="form-control" :value="old('nome')"  placeholder="Primeiro nome">
                    ...
                    <div class="input-group form-group">
						...
						<input type="sobrenome" name="sobrenome" class="form-control" :value="old('sobrenome')"  placeholder="Sobrenome">
                    ...
                    <div class="input-group form-group">
						...
						<input type="fone" name="fone" class="form-control" :value="old('fone')"  placeholder="Celular">
